...
<div class="container">
  <el-card class="box-card" body-style="padding:0;">
    <div slot="header" class="clearfix">
      <el-button type="success" @click="showDialog" v-show="hasPermission('create')">添加视频分类</el-button>
    </div>
  ...
  <el-dialog title="视频分类管理" :visible.sync="dialogVisible" :modal-append-to-body="false">
    <el-form :model="form">
